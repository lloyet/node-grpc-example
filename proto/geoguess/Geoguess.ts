...
export interface GeoguessClient extends grpc.Client {
	...
	): grpc.ClientWritableStream<_geoguess_Capital>;
	createListCapital(
		metadata: grpc.Metadata,
		callback: grpc.requestCallback<_google_protobuf_Empty__Output>
	): grpc.ClientWritableStream<_geoguess_Capital>;
	...
	getCapital(
		argument: _geoguess_Point,
		metadata: grpc.Metadata,
		options: grpc.CallOptions,
		callback: grpc.requestCallback<_geoguess_Capital__Output>
	...
	guessCapital(
		...
		metadata: grpc.Metadata,
		options?: grpc.CallOptions
	): grpc.ClientReadableStream<_geoguess_Capital__Output>;
	guessCapital(
		argument: _geoguess_Point,
		options?: grpc.CallOptions
	): grpc.ClientReadableStream<_geoguess_Capital__Output>;
	...
	logGuess(
		metadata: grpc.Metadata,
		options?: grpc.CallOptions
	): grpc.ClientDuplexStream<_geoguess_Point, _geoguess_Log__Output>;
	logGuess(
		options?: grpc.CallOptions
	): grpc.ClientDuplexStream<_geoguess_Point, _geoguess_Log__Output>;
	logGuess(
...
export interface GeoguessHandlers extends grpc.UntypedServiceImplementation {
	createListCapital: grpc.handleClientStreamingCall<
		_geoguess_Capital__Output,
...
export interface GeoguessDefinition extends grpc.ServiceDefinition {
	createListCapital: MethodDefinition<
		_geoguess_Capital,
		_google_protobuf_Empty,
		_geoguess_Capital__Output,
		_google_protobuf_Empty__Output
	>;
	getCapital: MethodDefinition<
		_geoguess_Point,
		_geoguess_Capital,
		_geoguess_Point__Output,
		_geoguess_Capital__Output
	>;
	guessCapital: MethodDefinition<
		_geoguess_Point,
		_geoguess_Capital,
		_geoguess_Point__Output,
		_geoguess_Capital__Output
	>;
	logGuess: MethodDefinition<
		_geoguess_Point,
		_geoguess_Log,
		_geoguess_Point__Output,
		_geoguess_Log__Output
	>;
}
